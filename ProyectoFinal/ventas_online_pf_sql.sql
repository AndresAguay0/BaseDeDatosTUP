-- Creacion de tablas del proyecto
...
CREATE INDEX idx_cliente_ordenes ON Ordenes(id_cliente);
CREATE INDEX idx_producto_detalle ON DetalleOrden(id_producto);
...
('Cliente 1', 'cliente1@ejemplo.com', 'Dirección 1'),
('Cliente 2', 'cliente2@ejemplo.com', 'Dirección 2'),
('Cliente 3', 'cliente3@ejemplo.com', 'Dirección 3'),
('Cliente 4', 'cliente4@ejemplo.com', 'Dirección 4'),
('Cliente 5', 'cliente5@ejemplo.com', 'Dirección 5'),
('Cliente 6', 'cliente6@ejemplo.com', 'Dirección 6'),
('Cliente 7', 'cliente7@ejemplo.com', 'Dirección 7'),
('Cliente 8', 'cliente8@ejemplo.com', 'Dirección 8'),
('Cliente 9', 'cliente9@ejemplo.com', 'Dirección 9'),
('Cliente 10', 'cliente10@ejemplo.com', 'Dirección 10');
...
-- Procedimiento para registrar una orden
DELIMITER $$
...
BEGIN
    ...
    SELECT stock INTO stock_actual FROM Productos WHERE id_producto = producto_id;
